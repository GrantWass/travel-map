    ...
    return (
        <div className="space-y-2">
            ...
            <div className="relative">
                <div className="flex items-center gap-2 rounded-xl border border-border bg-card px-3 py-2.5 shadow-md">
                ...
                {showSuggestions ? (
                    <div className="absolute left-0 right-0 z-20 mt-1 max-h-56 overflow-y-auto rounded-xl border border-border bg-card p-1 shadow-lg">
                        {isLoading ? (
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                {allowMapPin ? (
                    <button
                        ...
                        className="rounded-full border border-input bg-card px-3 py-1 text-xs font-semibold text-foreground/80 transition-all duration-200 hover:bg-secondary hover:shadow-xs"
                    >
                        Drop pin on map
                    </button>
                ) : null}
